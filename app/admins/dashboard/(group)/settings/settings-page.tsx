...
export default function SettingsPage({ session }: { session: any }) {
  ...
  const { data, mutate } = useSWR(`/api/admins/${session?.user.username}/settings?license=${session?.user.license_key}`, fetcher, {
  ...
  const handleSubmit = async () => {
    ...
    const res = await fetch(`/api/admins/${session?.user.username}/settings?license=${session?.user?.license_key}`, {
      method: 'POST',
      headers: {
          ...
          <div className="grid grid-cols-4 gap-5">
            ...
            <div className="col-span-4 flex flex-col justify-center w-full mt-4">
              <div className="grid grid-cols-4 items-center gap-5">
                <div className="col-span-4 sm:col-span-2 flex flex-row w-full items-center">
            ...
            <div className="flex col-span-4 justify-start p-2 font-semibold">
