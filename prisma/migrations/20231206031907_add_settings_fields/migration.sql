...
-- AlterTable
ALTER TABLE `settings` ADD COLUMN `shop_close_hours` TIME NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `shop_open_hours` TIME NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    MODIFY `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    MODIFY `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
